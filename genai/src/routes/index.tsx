...
import type { ScanResult, Severity, Finding } from "./api/scan";

export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "PQHorizon — Post-Quantum Crypto Readiness" },
      {
        name: "description",
        content:
          "Free post-quantum TLS preview. See what breaks before your auditor asks — built for teams facing the 2029 PQ migration deadline.",
      },
      { property: "og:title", content: "PQHorizon — Post-Quantum Crypto Readiness" },
      {
        property: "og:description",
        content:
          "Free post-quantum TLS preview and a defensible crypto inventory before your compliance deadline.",
      },
    ],
  }),
